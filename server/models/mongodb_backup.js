...
var dbOptions = {
    ...
    autoBackupPath: '../config/' // <serverPath> // i.e. /var/database-backup/
};
/* return date object */
...
exports.dbAutoBackUp = function() {
    ...
    if (dbOptions.autoBackup == true) {
        ...
        var cmd = '"C:\\Program Files\\MongoDB\\Server\\4.2\\bin\\mongodump.exe" --host ' + dbOptions.host + ' --port ' + dbOptions.port + ' --db ' + dbOptions.database + ' --out "' + newBackupPath + '"'; // Command for mongodb dump process
        console.log(cmd);
        var that = this;
